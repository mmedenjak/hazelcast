...
public abstract class AbstractQuorumTest2 {
    ...
    protected PartitionedCluster cluster;
    private TestHazelcastInstanceFactory factory;


    protected void initTestEnvironment(Config config, TestHazelcastInstanceFactory factory) {
        if (this.factory != null){
            throw new IllegalStateException("WOOT WOOT");
        }
        this.factory = factory;
        initCluster(PartitionedCluster.createClusterConfig(config), factory, READ, WRITE, READ_WRITE);
    }

    protected void shutdownTestEnvironment() {
    ...
    protected void initCluster(Config config, TestHazelcastInstanceFactory factory, QuorumType... types) {
    ...
    private void initData(QuorumType[] types) {
        for (QuorumType quorumType : types) {
