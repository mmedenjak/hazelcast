...
public class CollectionMergeOperation extends CollectionBackupAwareOperation {
    ...
    private List<ValueHolder<Data>> mergingValues;
    ...
    public void run() throws Exception {
        ...
        for (ValueHolder<Data> mergingValue : mergingValues) {
    ...
    protected void readInternal(ObjectDataInput in) throws IOException {
        ...
        int size = in.readInt();
        mergingValues = new ArrayList<ValueHolder<Data>>(size);
        for (int i = 0; i < size; i++) {
            ValueHolder<Data> mergingValue = in.readObject();
