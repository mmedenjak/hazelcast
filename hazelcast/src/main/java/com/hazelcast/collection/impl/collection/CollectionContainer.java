...
public abstract class CollectionContainer implements IdentifiedDataSerializable {
     ...
     */
    public CollectionItem merge(ValueHolder<Data> mergingValue,
                                SplitBrainMergePolicy<Data, ValueHolder<Data>> mergePolicy) {
        ...
        if (existingItem == null) {
            ...
            ValueHolder<Data> existingValue = createMergeHolder(existingItem);
