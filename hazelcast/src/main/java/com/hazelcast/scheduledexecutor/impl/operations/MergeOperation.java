...
public class MergeOperation
    ...
    private List<EntryHolder<String, ScheduledTaskDescriptor>> mergingEntries;
    ...
    public void run()
        ...
        for (EntryHolder<String, ScheduledTaskDescriptor> mergingEntry : mergingEntries) {
    ...
    protected void readInternal(ObjectDataInput in)
        ...
        int size = in.readInt();
        mergingEntries = new ArrayList<EntryHolder<String, ScheduledTaskDescriptor>>(size);
        for (int i = 0; i < size; i++) {
            EntryHolder<String, ScheduledTaskDescriptor> mergingEntry = in.readObject();
