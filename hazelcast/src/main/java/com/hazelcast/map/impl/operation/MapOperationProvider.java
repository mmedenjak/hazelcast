...
public interface MapOperationProvider {
    ...
    MapOperation createMergeOperation(String name, EntryHolder<Data, Data> mergingValue, SplitBrainMergePolicy mergePolicy,
                                      boolean disableWanReplicationEvent);
    ...
    OperationFactory createMergeOperationFactory(String name, int[] partitions,
                                                 List<EntryHolder<Data, Data>>[] mergingEntries,
