...
public class QueryRunner {
    ...
    /**
     * Runs a query on a chunk of a single partition. The chunk is defined by the {@code pointers} and the soft limit is defined by the
     * {@code fetchSize}.
     *
    ...
    public ResultSegment runPartitionScanQueryOnPartitionChunk(Query query,
        ...
        final QueryableEntriesSegment entries = partitionScanExecutor.execute(
                query.getMapName(), predicate, partitionId, pointers, fetchSize);
