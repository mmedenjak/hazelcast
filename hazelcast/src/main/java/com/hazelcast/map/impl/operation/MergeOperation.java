...
public class MergeOperation extends MapOperation implements PartitionAwareOperation, BackupAwareOperation {
    ...
    MergeOperation(String name, List<EntryHolder<Data, Data>> mergingEntries, SplitBrainMergePolicy mergePolicy,
    ...
    public void run() {
        ...
        for (EntryHolder<Data, Data> mergingEntry : mergingEntries) {
            merge(mergingEntry);
        }
    }

    private void merge(EntryHolder<Data, Data> mergingEntry) {
    ...
    protected void readInternal(ObjectDataInput in) throws IOException {
        ...
        int size = in.readInt();
        mergingEntries = new ArrayList<EntryHolder<Data, Data>>();
