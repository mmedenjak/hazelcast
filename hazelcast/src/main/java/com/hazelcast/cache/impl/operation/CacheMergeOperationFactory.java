...
public class CacheMergeOperationFactory extends PartitionAwareOperationFactory {
    ...
    private String name;
    private List<EntryHolder<Data, Data>>[] mergingEntries;
    ...
    public CacheMergeOperationFactory(String name, int[] partitions, List<EntryHolder<Data, Data>>[] mergingEntries,
    ...
    public void writeData(ObjectDataOutput out) throws IOException {
        ...
        for (List<EntryHolder<Data, Data>> list : mergingEntries) {
            out.writeInt(list.size());
            for (EntryHolder<Data, Data> mergingEntry : list) {
    ...
    public void readData(ObjectDataInput in) throws IOException {
        ...
        for (int partitionIndex = 0; partitionIndex < partitions.length; partitionIndex++) {
            int size = in.readInt();
            List<EntryHolder<Data, Data>> list = new ArrayList<EntryHolder<Data, Data>>(size);
            for (int i = 0; i < size; i++) {
                EntryHolder<Data, Data> mergingEntry = in.readObject();
