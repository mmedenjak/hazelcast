 ...
 */
public class PNCounterAddMessageTask extends AbstractInvocationMessageTask<PNCounterAddCodec.RequestParameters> {
    ...
    protected Operation prepareOperation() {
        return new AddOperation(parameters.name, parameters.delta, parameters.getBeforeUpdate);
    }
    ...
    protected ClientMessage encodeResponse(Object response) {
        return PNCounterAddCodec.encodeResponse((Long) response);
    }
