...
public class MergeOperationFactory extends PartitionAwareOperationFactory {
    ...
    private String name;
    private List<EntryHolder<Object, Object>>[] mergingEntries;
    ...
    public MergeOperationFactory(String name, int[] partitions, List<EntryHolder<Object, Object>>[] mergingEntries,
    ...
    public void writeData(ObjectDataOutput out) throws IOException {
        ...
        for (List<EntryHolder<Object, Object>> list : mergingEntries) {
            out.writeInt(list.size());
            for (EntryHolder<Object, Object> mergingEntry : list) {
    ...
    public void readData(ObjectDataInput in) throws IOException {
        ...
        for (int partitionIndex = 0; partitionIndex < partitions.length; partitionIndex++) {
            int size = in.readInt();
            List<EntryHolder<Object, Object>> list = new ArrayList<EntryHolder<Object, Object>>(size);
            for (int i = 0; i < size; i++) {
                EntryHolder<Object, Object> mergingEntry = in.readObject();
