...
public class MergeOperation extends AbstractNamedSerializableOperation {
    ...
    MergeOperation(String name, List<EntryHolder<Object, Object>> mergingEntries, SplitBrainMergePolicy mergePolicy) {
        this.name = name;
    ...
    public void run() {
        ...
        for (EntryHolder<Object, Object> mergingEntry : mergingEntries) {
    ...
    protected void readInternal(ObjectDataInput in) throws IOException {
        ...
        name = in.readUTF();
        int size = in.readInt();
        mergingEntries = new ArrayList<EntryHolder<Object, Object>>(size);
